...
class ISO9075Mapper
{
    ...
    {
        $sqlIdentifier = str_replace("_","-",$sqlIdentifier);
        /*
        ...
        $XMLN = self::replaceWrongChars($XMLN);
        return $XMLN;
    }


    private static function replaceWrongChars($str) {

        $str = str_replace("_x0025_20","_x0020_",$str);
