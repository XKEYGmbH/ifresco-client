Ext.define('Ifresco.view.CurrencyFields', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.ifrescoViewCurrencyFields',
    border: 0,
    autoScroll: true,
    closeAction: 'hide',
    cls: 'ifresco-view-currencyfields',
    configData: null,
    loaded: false,
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            ...
            items: [{
                ...
                items: [{
                    ...
                    listConfig: {
                        border: 0,
                        itemTpl: Ext.create('Ifresco.view.template.CurrencyProperty')
                    },
                    listeners: {
    ...
    loadData: function(data) {
        ...
        this.down('propertyselector').initData();
    },
