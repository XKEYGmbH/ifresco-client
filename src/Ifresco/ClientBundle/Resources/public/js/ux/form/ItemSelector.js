        ...
        return Ext.create('Ext.ux.form.MultiSelect', {
            ...
            tbar: [{
            	...
            	setReadOnly: function() {
            		//console.log("TRY TO SETR EADONLY ON FILTER")
            		return false; // BLOCK READONLY!
            	},
            	listeners: {
            		change:function(self, newValue, oldValue, eOpts) {
            			var bs = this.up("panel").down("boundlist").store;
            			console.log("TEXTFIELD FILTER CHANGED",this,bs);
            			bs.clearFilter();
            			if (String(newValue).trim() != "") {
            				//bs.filter(me.displayField, newValue, true, false);
            				bs.filterBy(function(rec, id){
	                            return me.filterFunc(rec, newValue);  
	                        }, this)
            			}
            		}
            	}
