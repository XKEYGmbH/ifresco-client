...
Ext.Loader.setConfig({
    enabled: true,
    paths: {
        'Ext.ux.upload': 'js/extjs4/ux/upload',
        'Ext.ux.statusbar': 'js/extjs4/ux/statusbar'
    }
});
...
Ext.define('Ext.ux.upload.IfsWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.ifsuploadwindow',
    ...
    initComponent: function()
    {
        ...
        uploader.actions.startTransform = Ext.create('Ext.Action', {
            ...
            handler: function() {
                ...
                if(files.length > 0) {
                    transformFiles([], '', files, uploader);
                }
            },
            scope: uploader
        });

        uploader.actions.start.setText('Upload');
